...
const u32 gItemIcon_Xernetite[] = INCBIN_U32("graphics/items/icons/xernetite.4bpp.lz");
const u32 gItemIconPalette_Xernetite[] = INCBIN_U32("graphics/items/icon_palettes/xernetite.gbapal.lz");
