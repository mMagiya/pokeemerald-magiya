...
// Begin Magiya Custom Additions
    ...
    [SPECIES_XERNEAS_NEUTRAL_REGIONAL] =
    {
        ...
        .cryId = CRY_XERNEAS,
        .natDexNum = NATIONAL_DEX_XERNEAS,
        .categoryName = _("New Life"),
        .height = 30,
        .weight = 2150,
        .description = gXerneasRegionalPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_XerneasNeutralRegional,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Xerneas,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_XerneasNeutralRegional,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_XerneasNeutralRegional,
        .shinyPalette = gMonShinyPalette_XerneasNeutralRegional,
        .iconSprite = gMonIcon_XerneasNeutralRegional,
        .iconPalIndex = 0,
        FOOTPRINT(Xerneas)
        .isLegendary = TRUE,
        .levelUpLearnset = sXerneasRegionalLevelUpLearnset,
        .teachableLearnset = sXerneasRegionalTeachableLearnset,
        .formSpeciesIdTable = sXerneasRegionalFormSpeciesIdTable,
        .formChangeTable = sXerneasRegionalFormChangeTable,
    },
    ...
    [SPECIES_XERNEAS_ACTIVE_REGIONAL] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_XerneasActiveRegional,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Xerneas,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_XerneasActiveRegional,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_XerneasActiveRegional,
        .shinyPalette = gMonShinyPalette_XerneasActiveRegional,
        .iconSprite = gMonIcon_XerneasActiveRegional,
        .iconPalIndex = 0,
        FOOTPRINT(Xerneas)
        .isLegendary = TRUE,
        .levelUpLearnset = sXerneasRegionalLevelUpLearnset,
    ...
    [SPECIES_XERNEAS_MEGA_REGIONAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WORLD_TREE, ABILITY_WORLD_TREE, ABILITY_WORLD_TREE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Xerneas"),
        .cryId = CRY_XERNEAS,
        .natDexNum = NATIONAL_DEX_XERNEAS,
        ...
        .height = 30,
        .weight = 2150,
        .description = gXerneasMegaRegionalPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_XerneasMegaRegional,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Xerneas,
        .frontAnimId = ANIM_SHAKE_GLOW_GREEN,
        .backPic = gMonBackPic_XerneasMegaRegional,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_XerneasMegaRegional,
        .shinyPalette = gMonShinyPalette_XerneasMegaRegional,
        .iconSprite = gMonIcon_XerneasMegaRegional,
        .iconPalIndex = 0,
        FOOTPRINT(Xerneas)
        .isLegendary = TRUE,
        .levelUpLearnset = sXerneasRegionalLevelUpLearnset,
