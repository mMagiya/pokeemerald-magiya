...
#define VAR_WEATHER_CURRENT                              0x40F7 // Current state of the Weather system
#define VAR_WEATHER_PREVIOUS                             0x40F8 // Unused Var - previous state of the Weather system
